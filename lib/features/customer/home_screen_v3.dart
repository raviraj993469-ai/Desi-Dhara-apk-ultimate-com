      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Namaste, Ananya 👋', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.deepForestGreen)),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('221B, Green Park Extension, New Delhi - 110016', style: TextStyle(fontSize: 12, color: AppColors.textLight)),
              ],
            ),
          ),
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Naturally Rich A2 Cow Milk', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              _buildSubDetail('Next Delivery', '24 May 2025'),
              _buildSubDetail('Price', '₹69 / Litre'),
            ],
          ),
        ],
      ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('Share the goodness, Earn rewards!', style: TextStyle(fontSize: 12, color: AppColors.textLight)),
      ...
      child: Column(
        ...
        children: [
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text('OUR BESTSELLERS', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.deepForestGreen)),
